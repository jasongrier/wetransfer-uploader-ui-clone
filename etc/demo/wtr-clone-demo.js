;(function (global, factory) {
  ...
  function Info(_a) {
    var progressCircleRefs = _a.progressCircleRefs
    ...
    var _b = useSelector(function (state) {
      ...
      fileCount = _b.fileCount,
      recipientsCount = _b.recipientsCount,
      timeRemaining = _b.timeRemaining,
      totalSize = _b.totalSize,
      uploadedSize = _b.uploadedSize,
      uploadInProgress = _b.uploadInProgress

    React.useEffect(
      function renderProgressDirty() {
        var progressSvgEl =
          progressCircleRefs === null || progressCircleRefs === void 0 ? void 0 : progressCircleRefs.frameRef.current
        var progressCircleEl =
          progressCircleRefs === null || progressCircleRefs === void 0 ? void 0 : progressCircleRefs.barRef.current
    ...
    if (!uploadInProgress) return React__default['default'].createElement('div', null)
    return React__default['default'].createElement(
    ...
    React.useEffect(
      function startUploading() {
        var timeoutId = window.setTimeout(function () {
          var updatedUploadedSize = uploadedSize + 10000000
  ...
  function Footer() {
    var uploadInProgress = useSelector(function (state) {
      return {
        uploadInProgress: state.uploadInProgress,
      }
    }).uploadInProgress
  ...
  var FunButtons = Ye(FunButtons$1)(
    templateObject_3 ||
  ...
  function App(_a) {
    return React__default['default'].createElement(
      ...
      React__default['default'].createElement(FunButtons, null),
